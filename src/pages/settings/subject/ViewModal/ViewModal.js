          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <Form.Control disabled type="text" value={course_subject && course_subject.name !=='' ? course_subject.name :''} />
                <Form.Label className="ms-1 mt-2">Description</Form.Label>
                <Form.Control disabled type="text" value={course_subject && course_subject.desc !=='' ? course_subject.desc :''} />
                <Form.Label className="ms-1 mt-2">Status</Form.Label>
                <Form.Control disabled type="text" value={course_subject && course_subject.status !=='' ? course_subject.status :''} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
