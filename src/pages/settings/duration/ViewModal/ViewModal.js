          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <Form.Control disabled type="text" value={course_duration && course_duration.name !=='' ? course_duration.name :''} />
                <Form.Label className="ms-1 mt-2">Description</Form.Label>
                <Form.Control disabled type="text" value={course_duration && course_duration.desc !=='' ? course_duration.desc :''} />
                <Form.Label className="ms-1 mt-2">Status</Form.Label>
                <Form.Control disabled type="text" value={course_duration && course_duration.status !=='' ? course_duration.status :''} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
