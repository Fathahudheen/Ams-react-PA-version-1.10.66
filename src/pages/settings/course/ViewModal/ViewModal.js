          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <Form.Control disabled type="text" value={course_setup && course_setup.name !=='' ? course_setup.name :''} />
                <Form.Label className="ms-1 mt-2">Description</Form.Label>
                <Form.Control disabled type="text" value={course_setup && course_setup.desc !=='' ? course_setup.desc :''} />
                <Form.Label className="ms-1 mt-2">Status</Form.Label>
                <Form.Control disabled type="text" value={course_setup && course_setup.status !=='' ? course_setup.status :''} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
