          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <Form.Control disabled type="text" value={course_track && course_track.name !=='' ? course_track.name :''} />
                <Form.Label className="ms-1 mt-2">Description</Form.Label>
                <Form.Control disabled type="text" value={course_track && course_track.desc !=='' ? course_track.desc :''} />
                <Form.Label className="ms-1 mt-2">Status</Form.Label>
                <Form.Control disabled type="text" value={course_track && course_track.status !=='' ? course_track.status :''} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
