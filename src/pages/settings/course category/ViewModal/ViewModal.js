          ...
          <Container>
            <Row>
              <Col lg={12}>
                ...
                <Form.Control disabled type="text" value={course_ctgry && course_ctgry.name !=='' ? course_ctgry.name :''} />
                <Form.Label className="ms-1 mt-2">Description</Form.Label>
                <Form.Control disabled type="text" value={course_ctgry && course_ctgry.desc !=='' ? course_ctgry.desc :''} />
                <Form.Label className="ms-1 mt-2">Status</Form.Label>
                <Form.Control disabled type="text" value={course_ctgry && course_ctgry.status !=='' ? course_ctgry.status :''} />
              </Col>
            </Row>
          </Container>
        </Modal.Body>
